                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>Restaurant POS Lounge</strong>
                                <br>
                                127-0-0-1
                                <br>
                                Orchid Colony,Kalanki-Kathmandu
                                <br>
                                9814140050
                            </address>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">NRs.<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center">NRs.<?php echo $total; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    ...
                                    <td class="text-center">
                                        <p>
                                            <strong>NRs.<?php echo $total; ?></strong>
                                        </p>
                                        <p>
                                            <strong>14%</strong>
                                        </p>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>NRs.<?php echo $total; ?></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
